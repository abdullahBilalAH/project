...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container mt-5">
            <h1 class="text-center mb-4">Market Products</h1>
            <div class="row">
                @foreach ($DB as $item)
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('add.to.cart', $item['itemID']) }}">
                                @csrf
                                <div class="input-group justify-content-center mb-3">
                                    <button type="submit" name="action" value="decrement" class="btn btn-danger">-</button>
                                    <input type="text" class="form-control text-center" name="counter" value="{{ session('cart.' . $item->itemID, 0) }}" readonly>
            ...
            <div class="text-center mt-4">
                <a href="{{route('cart.page')}}" class="btn btn-secondary">Go to Cart</a>
            </div>
        </div>
